    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.PositiveSmallIntegerField(choices=[(1, 'Администратор'), (2, 'Главный менеджер'), (3, 'Менеджер'), (4, 'Логистика'), (5, 'Мастер'), (6, 'Бухгалтер'), (7, 'Владелец'), (8, 'Супервайзер производства'), (9, 'Дизайнер')], default=7)),
                ('telegram_chat_id', models.CharField(blank=True, max_length=18, null=True)),
            ...
            managers=[
                ('objects', account.models.UserQueryset()),
            ],
        ),
    ]
